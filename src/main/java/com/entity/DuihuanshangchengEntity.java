...
public class DuihuanshangchengEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public DuihuanshangchengEntity() {
		
	}
	
	public DuihuanshangchengEntity(T t) {
		try {
	 ...
	 * 设置：所需环保币
	 */
	public void setSuoxuhuanbaobi(String suoxuhuanbaobi) {
		this.suoxuhuanbaobi = suoxuhuanbaobi;
	}
	/**
	 * 获取：所需环保币
	 */
	public String getSuoxuhuanbaobi() {
		return suoxuhuanbaobi;
	}
	/**
	 * 设置：商品介绍
	 */
